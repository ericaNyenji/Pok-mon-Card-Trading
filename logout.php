<?php 
 ...
 header('location:main.php'); //can take to login page doesn't matter because index page  immediately redirect to login because he's not loggied in to login page ????????//WHAT IF TWO USERS WERE LOGGED IN??WILL IT BE UNDER THE SAME SESSION
 exit()
