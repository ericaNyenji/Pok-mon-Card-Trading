...
header('location: main.php?message=Congratulations!  Card purchased successfully!&success=1');
exit;

    } else {
       // echo "Insufficient funds or reached card limit.";
      
    header('location: main.php?message=Check if you have Insufficient funds or have already reached card limit which is 5 cards.');
exit;

    }
} else {
    //echo "Invalid request.";
    header('location: main.php?message=Invalid request.');
    exit;
}
?>
